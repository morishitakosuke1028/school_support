                        ...
                        <section class="text-gray-600 body-font">
                            <div class="container px-5 py-24 mx-auto">
                                <div class="w-full mx-auto overflow-auto">
                                    <h3 class="text-2xl font-semibold mb-4">成長記録　生徒一覧</h3>
                                    <table class="table-auto w-full text-left whitespace-no-wrap" id="sort_table">
                                        ...
                                        <tbody v-for="child in children" :key="child.id">
                                            <tr>
                                                <span>
                                                    <td class="px-4 py-3">
                                                        <Link as="button" class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" :href="route('growths.create', { growth: child.id })">
                                                            登録
                                                        </Link>
                                                    </td>
                                                </span>

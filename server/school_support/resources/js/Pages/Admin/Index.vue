                                    ...
                                    <table class="table-auto w-full text-left whitespace-no-wrap" id="sort_table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">役割</th>
                                            </tr>
                                        </thead>
                                        <tbody v-for="user in users.data" :key="user.id">
                                            <tr>
                                                ...
                                                <td class="px-4 py-3">
                                                    <span v-if="user.role === 1">編集者</span>
                                                    <span v-if="user.role === 2">閲覧者</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
